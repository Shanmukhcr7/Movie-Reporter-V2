...
import { Film, TrendingUp, Calendar, Star, Users, Newspaper } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold mb-2">Latest Movies</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold mb-2">Upcoming Releases</h2>
        ...
        <section className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold mb-2">Weekly Magazine</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold mb-2">Celebrity Profiles</h2>
