  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="sticky top-20 z-30 bg-background/95 backdrop-blur py-4 mb-8 -mx-4 px-4 border-b border-border/40">
            ...
            {categories.map((category) => {
              ...
              return (
                <div key={category.id} className="scroll-mt-24 awards-category-block" id={category.id}>
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 border-b pb-4">
                    <div>
